    ...
    return (
        <header className="padding-x py-8 absolute z-10 w-full">
            <nav className="flex justify-between items-center max-container">
                ...
                <a href="#Sign-in" className=" flex justify-center items-center gap-16 max-lg:hidden fonts-montserrat text-lg text-black leading-normal"> Sign in / Explore now</a>
                <div className="">
